...
cmd({
  ...
  try {
    ...
    const rawVersionUrl = 'https://raw.githubusercontent.com/Silatrix2/SILA-MD/main/data/version.json';
    ...
    // GitHub stats
    const githubRepo = 'https://github.com/Silatrix2/SILA-MD';
...
Use *.update* to update.`;
    ...
    const statusMessage = `🌟 *Good ${new Date().getHours() < 12 ? 'Morning' : 'Night'}, ${pushname}!* 🌟\n\n` +
      ...
      `📝 *Changelog:*\n${latestChangelog}\n\n` +
      `⭐ *GitHub Repo:* ${githubRepo}\n👤 *Owner:* [Sila Tech](wa.me/94788770020)\n\n${updateMessage}\n\n🚀 *Hey! Don't forget to fork & star the repo!*`;
