...
cmd({
    ...
    try {
        ...
        const { data: commitData } = await axios.get("https://api.github.com/repos/Silatrix2/SILA-MD/commits/main");
        ...
        const { data: zipData } = await axios.get("https://github.com/Silatrix2/SILA-MD/archive/main.zip", { responseType: "arraybuffer" });
        ...
        const sourcePath = path.join(extractPath, "SILA-MD-main");
